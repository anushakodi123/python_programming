class JobProfessional:
    def __init__(self, yearly_income, portion_saved, cost_of_dream_home, portion_down_payment, r):
        self.amount_saved = 0
...
j = JobProfessional(yearly_salary, portion_saved, cost_of_dream_home, portion_down_payment, r)
